...
- [x] Attach the event to Charlie's account after he signs in on the new domain (done 2026-09-21 18:25 UTC with one update of `events.account_id`).
- [ ] Decide with Charlie whether the Fly app and volume are destroyed.
